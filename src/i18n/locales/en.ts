...
const en = {
	...
	'sourceControl.status.added': 'Added',
	'sourceControl.status.modified': 'Modified',
	'sourceControl.status.renamed': 'Renamed',
	'sourceControl.status.deletedLocally': 'Deleted locally',
	'sourceControl.status.deletedLocally.tooltip': 'Remote file will be removed during sync',
